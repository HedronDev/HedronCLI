...
use Hedron\CLI\Command\DockerExecCommand;
use Hedron\CLI\Command\DockerInspectCommand;
...
use Hedron\CLI\Command\DockerStatsCommand;
...
$application->add(new DockerInspectCommand());
$application->add(new DockerExecCommand());
$application->add(new DockerStatsCommand());
